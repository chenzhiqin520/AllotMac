...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/work/lede/source-17.01.4-LS1012A/staging_dir/toolchain-aarch64_armv8-a_gcc-5.4.0_glibc-2.24/aarch64-openwrt-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
